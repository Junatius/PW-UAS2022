  ...
  <body>
    ...
    <section class="login">
      <form action="" method="post">
          ...
          <p style="margin-left: 4rem;">don't have an account?</p>
            <button style="margin-top: -0.5rem;" link="register.php" class="login btn register"><a href="register.php">register now</a></button>
      </form>
    </section>
  </body>
</html>
